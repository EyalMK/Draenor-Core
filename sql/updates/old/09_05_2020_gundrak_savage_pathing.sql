DELETE FROM `creature_formations` WHERE `leaderGUID`=119330;
INSERT INTO `creature_formations` (`leaderGUID`, `memberGUID`, `dist`, `angle`, `groupAI`) VALUES
(119330, 119330, 0, 0, 1),
(119330, 119331, 2, 90, 2);

-- Pathing for Gundrak Savage Entry: 29235 'TDB FORMAT' 
SET @NPC := 119330;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`=0,`MovementType`=2,`position_x`=6332.113,`position_y`=-4009.055,`position_z`=457.2701 WHERE `guid` IN (@NPC, @NPC+1);
