...
(11,58951,11.0,1,1,1,1,""),
(14,58951,7.0,1,1,1,1,""),
(16,58951,0.0001,1,1,1,1,""),
(17,58951,7.0,1,1,1,1,""),
(814,58951,5.0,1,1,1,1,""),
(815,58951,5.0,1,1,1,1,"");

UPDATE locales_quest SET EndText_loc3="", OfferRewardText_loc3="$N, Ihr habt einen! Einen so starken, schönen Fisch bekommt man nur selten zu Gesicht.", RequestItemsText_loc3="Konntet Ihr einen riesigen Hecht fangen?", CompletedText_loc3="Liefert den riesigen wütenden Hecht bei Razgar in Orgrimmar ab." WHERE entry=26588;

update gameobject_loot_template set ChanceOrQuestChance=85 where entry=180663 and item=21071;