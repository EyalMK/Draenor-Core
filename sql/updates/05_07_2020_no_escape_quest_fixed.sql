...
update creature set spawndist=0, MovementType=0 where id=45032 and guid=306499;
...
(44989, 0, 0, "The Forsaken have broken through your defenses, magistrate.", 12, 0, 100, 396, 0, 0, ""),
(44989, 1, 0, "You are out of time.", 12, 0, 100, 274, 0, 0, ""),
(44989, 2, 0, "A decision must be made!", 12, 0, 100, 5, 0, 0, ""),
(44989, 3, 0, "Die in battle and be raised as a servant of the Forsaken or...", 12, 0, 100, 396, 0, 0, ""),
(44989, 4, 0, "Drink in my blood and be reborn as worgen, immune to the depravity of the Forsaken.", 12, 0, 100, 396, 0, 0, ""),
(44989, 5, 0, "Help us destroy the Forsaken and retake Lordaeron for the Alliance!", 12, 0, 100, 5, 0, 0, "");

DELETE FROM creature_text where entry=44996 and groupid in (0, 1);
INSERT INTO creature_text values 
(44996, 0, 0, "We would rather die than be turned into worgen, but seeing as how even death provides no relief from the atrocities of this war...", 12, 0, 100, 1, 0, 0, ""),
(44996, 1, 0, "We choose vengeance!", 12, 0, 100, 5, 0, 0, "");

DELETE FROM creature_text where entry=44951 and groupid in (2, 3);
INSERT INTO creature_text values 
(44951, 2, 0, "Run...", 12, 0, 100, 457, 0, 0, ""),
