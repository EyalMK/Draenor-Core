...
(19, 0, 28966, 0, 0, 12, 0, 12, 0, 0, 0, 0, "", "Quest available only during Hallow's End event");

delete from creature where id=44915;

UPDATE locales_quest SET EndText_loc3="", RequestItemsText_loc3="Wir sind die Verlassenen! So machen wir das, $C.", OfferRewardText_loc3="Ausgezeichnet! Und jetzt müssen wir das \"Mahl\" vorbereiten." WHERE entry=27082;

UPDATE quest_template SET PrevQuestId=27065 WHERE Id=27082;

UPDATE locales_quest SET QuestGiverTextWindow_loc3="Worgen des Hügellands", QuestGiverTargetName_loc3="Worgen des Hügellands" WHERE entry=27231;
...
UPDATE locales_quest SET OfferRewardText_loc3="AHA! Ich wusste es! Da haben wir wohl wieder etwas gelernt. Wir werden nicht wieder so versagen. Ich werde sicherstellen, dass immer Bier an vorderster Front bereitsteht.", QuestGiverTextWindow_loc3="Orcischer Seebär", QuestGiverTargetName_loc3="Orcischer Seebär" WHERE entry=27226;
...
UPDATE locales_quest SET OfferRewardText_loc3="Dieses Fiasko könnte als eine der größten Peinlichkeiten in die Geschichte der Seekriegsführung eingehen. Wie das passiert ist? Trunkenheit ist passiert. So war das." WHERE entry=27065;

UPDATE locales_quest SET OfferRewardText_loc3="In diesen Kisten befindet sich STÄHLERNER DONNER! Jetzt, da unsere Waffen wieder da sind, haben wir vielleicht eine Möglichkeit, uns zu rehabilitieren.", QuestGiverTextWindow_loc3="Seebärenkiste", QuestGiverTargetName_loc3="Seebärenkiste" WHERE entry=27069;
...
(11901, 0, 0, "I seem to have misplaced my sea pup, admiral. Do you have another that you could lend to me?", 1, 1, 0, 0, 0, 0, "");
...
insert into conditions values 
(15, 0, 11901, 0, 0, 9, 0, 27069, 0, 0, 0, 0, "", "gossip avialable on quest taken");
