...
-- Dumping structure for table worldlive.mail_loot_template
...
-- Dumping data for table worldlive.mail_loot_template: 135 rows
DELETE FROM `mail_loot_template`;
/*!40000 ALTER TABLE `mail_loot_template` DISABLE KEYS */;
INSERT INTO `mail_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`, `itemBonuses`) VALUES
	(87, 6529, 100, 1, 0, 1, 1, ''),
