...
-- Delete duplicate
DELETE FROM `creature` WHERE `guid`=194297;
SET @NPC := 18298;
SET @PATH := @NPC * 10;
-- 1-2 hour respawn timer, uncommon rarity
UPDATE `creature` SET `spawndist`=0,`MovementType`=2, `modelid`=9534, `spawntimesecs`=5400 WHERE `guid`=@NPC;
