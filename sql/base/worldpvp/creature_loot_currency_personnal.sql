...
-- Dumping structure for table worldpvp.creature_loot_currency_personnal
...
-- Dumping data for table worldpvp.creature_loot_currency_personnal: ~67 rows (approximately)
