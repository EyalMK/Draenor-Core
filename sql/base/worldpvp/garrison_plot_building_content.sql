...
-- Dumping structure for table worldpvp.garrison_plot_building_content
...
-- Dumping data for table worldpvp.garrison_plot_building_content: ~0 rows (approximately)
