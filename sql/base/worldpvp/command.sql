...
-- Dumping structure for table worldpvp.command
...
-- Dumping data for table worldpvp.command: 458 rows
DELETE FROM `command`;
...
INSERT INTO `command` (`name`, `security`, `help`) VALUES
	...
	('debug arena', 4, 'Syntax: .debug arena\r\n\r\nToggle debug mode for arenas. In debug mode GM can start arena with single player.'),
	('debug bg', 4, 'Syntax: .debug bg\r\n\r\nToggle debug mode for battlegrounds. In debug mode GM can start battleground with single player.'),
	('debug Mod32Value', 4, 'Syntax: .debug Mod32Value #field #value\r\n\r\nAdd #value to field #field of your character.'),
	('debug play cinematic', 4, 'Syntax: .debug play cinematic #cinematicid\r\n\r\nPlay cinematic #cinematicid for you. You stay at place while your mind fly.\r\n'),
	('debug play movie', 4, 'Syntax: .debug play movie #movieid\r\n\r\nPlay movie #movieid for you.'),
	('debug play sound', 4, 'Syntax: .debug play sound #soundid\r\n\r\nPlay sound with #soundid.\r\nSound will be play only for you. Other players do not hear this.\r\nWarning: client may have more 5000 sounds...'),
	...
	('lookup object', 4, 'Syntax: .lookup object $objname\r\n\r\nLooks up an gameobject by $objname, and returns all matches with their Gameobject ID\'s.'),
	...
	('lookup quest', 4, 'Syntax: .lookup quest $namepart\r\n\r\nLooks up a quest by $namepart, and returns all matches with their quest ID\'s.'),
	('lookup skill', 4, 'Syntax: .lookup skill $$namepart\r\n\r\nLooks up a skill by $namepart, and returns all matches with their skill ID\'s.'),
	('lookup spell', 4, 'Syntax: .lookup spell $namepart\r\n\r\nLooks up a spell by $namepart, and returns all matches with their spell ID\'s.'),
	('lookup taxinode', 4, 'Syntax: .lookup taxinode $substring\r\n\r\nSearch and output all taxinodes with provide $substring in name.'),
	('lookup tele', 4, 'Syntax: .lookup tele $substring\r\n\r\nSearch and output all .tele command locations with provide $substring in name.'),
	('lookup', 4, 'Syntax: .lookup $subcommand\nType .lookup to see the list of possible subcommands or .help lookup $subcommand to see info on subcommands'),
	...
	('modify drunk', 4, 'Syntax: .modify drunk #value\r\n Set drunk level to #value (0..100). Value 0 remove drunk state, 100 is max drunked state.'),
	('modify energy', 4, 'Syntax: .modify energy #energy\r\n\r\nModify the energy of the selected player. If no player is selected, modify your energy.'),
	('modify faction', 4, 'Syntax: .modify faction #factionid #flagid #npcflagid #dynamicflagid\r\n\r\nModify the faction and flags of the selected creature. Without arguments, display the faction and flags of the selected creature.'),
	...
	('modify gender', 4, 'Syntax: .modify gender male/female\r\n\r\nChange gender of selected player.'),
	...
	('npc move', 4, 'Syntax: .npc move [#creature_guid]\r\n\r\nMove the targeted creature spawn point to your coordinates.'),
	...
	('reload spell_proc', 4, 'Syntax: .reload spell_proc\nReload spell_proc table.'),
	...
	('recall', 4, 'Syntax: .recall [$playername]\r\n\r\nTeleport $playername or selected player to the place where he has been before last use of a teleportation command. If no $playername is entered and no player is selected, it will teleport you.'),
	('reload all quest', 4, 'Syntax: .reload all quest\r\n\r\nReload all quest related tables if reload support added for this table and this table can be _safe_ reloaded.'),
	('reload all npc', 4, 'Syntax: .reload all npc\nReload npc_option, npc_trainer, npc vendor, points of interest tables.'),
	('reload all loot', 4, 'Syntax: .reload all loot\r\n\r\nReload all `*_loot_template` tables. This can be slow operation with lags for server run.'),
	('reload all item', 4, 'Syntax: .reload all item\nReload page_text, item_enchantment_table tables.'),
	('reload all locales', 4, 'Syntax: .reload all locales\r\n\r\nReload all `locales_*` tables with reload support added and that can be _safe_ reloaded.'),
	('reload all gossips', 4, 'Syntax: .reload all gossips\nReload gossip_menu, gossip_menu_option, gossip_scripts, points_of_interest tables.'),
	('reload all', 4, 'Syntax: .reload all\r\n\r\nReload all tables with reload support added and that can be _safe_ reloaded.'),
	('reload areatrigger_involvedrelation', 4, 'Syntax: .reload areatrigger_involvedrelation\nReload areatrigger_involvedrelation table.'),
	('reload areatrigger_tavern', 4, 'Syntax: .reload areatrigger_tavern\nReload areatrigger_tavern table.'),
	('reload areatrigger_teleport', 4, 'Syntax: .reload areatrigger_teleport\nReload areatrigger_teleport table.'),
	('reload autobroadcast', 4, 'Syntax: .reload autobroadcast\nReload autobroadcast table.'),
	('reload command', 4, 'Syntax: .reload command\nReload command table.'),
	('reload config', 4, 'Syntax: .reload config\r\n\r\nReload config settings (by default stored in trinityd.conf). Not all settings can be change at reload: some new setting values will be ignored until restart, some values will applied with delay or only to new objects/maps, some values will explicitly rejected to change at reload.'),
	('reload creature_questender', 4, 'Syntax: .reload creature_questender\nReload creature_questender table.'),
	('reload creature_linked_respawn', 4, 'Syntax: .reload creature_linked_respawn\r\nReload creature_linked_respawn table.'),
	('reload creature_loot_template', 4, 'Syntax: .reload creature_loot_template\nReload creature_loot_template table.'),
	('reload creature_queststarter', 4, 'Syntax: .reload creature_queststarter\nReload creature_queststarter table.'),
	('reload disenchant_loot_template', 4, 'Syntax: .reload disenchant_loot_template\nReload disenchant_loot_template table.'),
	('reload event_scripts', 4, 'Syntax: .reload event_scripts\nReload event_scripts table.'),
	('reload fishing_loot_template', 4, 'Syntax: .reload fishing_loot_template\nReload fishing_loot_template table.'),
	('reload game_graveyard_zone', 4, 'Syntax: .reload game_graveyard_zone\nReload game_graveyard_zone table.'),
	('reload game_tele', 4, 'Syntax: .reload game_tele\nReload game_tele table.'),
	('reload gameobject_questender', 4, 'Syntax: .reload gameobject_questender\nReload gameobject_questender table.'),
	('reload gameobject_loot_template', 4, 'Syntax: .reload gameobject_loot_template\nReload gameobject_loot_template table.'),
	('reload gameobject_queststarter', 4, 'Syntax: .reload gameobject_queststarter\nReload gameobject_queststarter table.'),
	('reload gameobject_scripts', 4, 'Syntax: .reload gameobject_scripts\nReload gameobject_scripts table.'),
	('reload gm_tickets', 3, 'Syntax: .reload gm_tickets\nReload gm_tickets table.'),
	('reload item_enchantment_template', 4, 'Syntax: .reload item_enchantment_template\nReload item_enchantment_template table.'),
	('reload item_loot_template', 4, 'Syntax: .reload item_loot_template\nReload item_loot_template table.'),
	('reload locales_creature', 4, 'Syntax: .reload locales_creature\nReload locales_creature table.'),
	('reload locales_gameobject', 4, 'Syntax: .reload locales_gameobject\nReload locales_gameobject table.'),
	('reload locales_npc_text', 4, 'Syntax: .reload locales_npc_text\nReload locales_npc_text table.'),
	('reload locales_page_text', 4, 'Syntax: .reload locales_page_text\nReload locales_page_text table.'),
	('reload locales_points_of_interest', 4, 'Syntax: .reload locales_points_of_interest\nReload locales_point_of_interest table.'),
	('reload locales_quest', 4, 'Syntax: .reload locales_quest\nReload locales_quest table.'),
	('reload milling_loot_template', 4, 'Syntax: .reload milling_loot_template\nReload milling_loot_template table.'),
	('reload npc_trainer', 4, 'Syntax: .reload npc_trainer\nReload npc_trainer table.'),
	('reload npc_vendor', 4, 'Syntax: .reload npc_vendor\nReload npc_vendor table.'),
	('reload page_text', 4, 'Syntax: .reload page_text\nReload page_text table.'),
	('reload pickpocketing_loot_template', 4, 'Syntax: .reload pickpocketing_loot_template\nReload pickpocketing_loot_template table.'),
	('reload points_of_interest', 4, 'Syntax: .reload points_of_interest\nReload points_of_interest table.'),
	('reload prospecting_loot_template', 4, 'Syntax: .reload prospecting_loot_template\nReload prospecting_loot_template table.'),
	('reload quest_end_scripts', 4, 'Syntax: .reload quest_end_scripts\nReload quest_end_scripts table.'),
	('reload mail_loot_template', 4, 'Syntax: .reload quest_mail_loot_template\nReload quest_mail_loot_template table.'),
	('reload quest_start_scripts', 4, 'Syntax: .reload quest_start_scripts\nReload quest_start_scripts table.'),
	('reload quest_template', 4, 'Syntax: .reload quest_template\nReload quest_template table.'),
	('reload reference_loot_template', 4, 'Syntax: .reload reference_loot_template\nReload reference_loot_template table.'),
	('reload reserved_name', 4, 'Syntax: .reload reserved_name\nReload reserved_name table.'),
	('reload skill_discovery_template', 4, 'Syntax: .reload skill_discovery_template\nReload skill_discovery_template table.'),
	('reload skill_extra_item_template', 4, 'Syntax: .reload skill_extra_item_template\nReload skill_extra_item_template table.'),
	('reload skill_fishing_base_level', 4, 'Syntax: .reload skill_fishing_base_level\nReload skill_fishing_base_level table.'),
	('reload skinning_loot_template', 4, 'Syntax: .reload skinning_loot_template\nReload skinning_loot_template table.'),
	('reload spell_area', 4, 'Syntax: .reload spell_area\nReload spell_area table.'),
	('reload spell_bonus_data', 4, 'Syntax: .reload spell_bonus_data\nReload spell_bonus_data table.'),
	('reload disables', 4, 'Syntax: .reload disables\r\nReload disables table.'),
	('reload spell_group_stack_rules', 4, 'Syntax: .reload spell_group\nReload spell_group_stack_rules table.'),
	('reload spell_learn_spell', 4, 'Syntax: .reload spell_learn_spell\nReload spell_learn_spell table.'),
	('reload spell_linked_spell', 4, 'Usage: .reload spell_linked_spell\r\nReloads the spell_linked_spell DB table.'),
	('reload spell_loot_template', 4, 'Syntax: .reload spell_loot_template\nReload spell_loot_template table.'),
	('reload spell_pet_auras', 4, 'Syntax: .reload spell_pet_auras\nReload spell_pet_auras table.'),
	('reload spell_proc_event', 4, 'Syntax: .reload spell_proc_event\nReload spell_proc_event table.'),
	('reload spell_required', 4, 'Syntax: .reload spell_required\nReload spell_required table.'),
	('reload spell_scripts', 4, 'Syntax: .reload spell_scripts\nReload spell_scripts table.'),
	('reload spell_target_position', 4, 'Syntax: .reload spell_target_position\nReload spell_target_position table.'),
	('reload spell_threats', 4, 'Syntax: .reload spell_threats\nReload spell_threats table.'),
	('reload trinity_string', 4, 'Syntax: .reload trinity_string\nReload trinity_string table.'),
	('reload waypoint_scripts', 4, 'Syntax: .reload waypoint_scripts\nReload waypoint_scripts table.'),
	('reload', 4, 'Syntax: .reload $subcommand\nType .reload to see the list of possible subcommands or .help reload $subcommand to see info on subcommands'),
	...
	('send message', 4, 'Syntax: .send message $playername $message\r\n\r\nSend screen message to player from ADMINISTRATOR.'),
	...
	('cheat explore', 4, 'Syntax: .cheat explore #flag\r\nReveal or hide all maps for the selected player. If no player is selected, hide or reveal maps to you.\r\nUse a #flag of value 1 to reveal, use a #flag value of 0 to hide all maps.'),
	('tele add', 4, 'Syntax: .tele add $name\r\n\r\nAdd current your position to .tele command target locations list with name $name.'),
	('tele del', 4, 'Syntax: .tele del $name\r\n\r\nRemove location with name $name for .tele command locations list.'),
	...
	('reload creature_onkill_reputation', 4, 'Syntax: .reload creature_onkill_reputation\r\nReload creature_onkill_reputation table.'),
	('reload conditions', 4, 'Reload conditions table.'),
	...
	('reload gossip_menu', 4, 'Syntax: .reload gossip_menu\nReload gossip_menu table.'),
	('reload gossip_menu_option', 4, 'Syntax: .reload gossip_menu_option\nReload gossip_menu_option table.'),
	...
	('reload all scripts', 4, 'Syntax: .reload all scripts\nReload gameobject_scripts, event_scripts, quest_end_scripts, quest_start_scripts, spell_scripts, db_script_string, waypoint_scripts tables.'),
	('reload locales_gossip_menu_option', 4, 'Syntax: .reload locales_gossip_menu_option\nReload locales_gossip_menu_option table.'),
	('reload quest_poi', 4, 'Syntax: .reload quest_poi\nReload quest_poi table.'),
	('reload lfg_dungeon_rewards', 4, 'Syntax: .reload lfg_dungeon_rewards\nReload lfg_dungeon_rewards table.'),
	...
	('npc set spawndist', 4, 'Syntax: .npc set spawndist #dist\r\n\r\nAdjust spawndistance of selected creature to dist.'),
	('npc set spawntime', 4, 'Syntax: .npc set spawntime #time \r\n\r\nAdjust spawntime of selected creature to time.'),
	('npc add temp', 4, 'Syntax: .npc add temp\r\n\r\nAdds temporary NPC, not saved to database.'),
	...
	('reload access_requirement', 4, 'Syntax: .reload access_requirement\nReload access_requirement table.'),
	('reload achievement_criteria_data', 4, 'Syntax: .reload achievement_criteria_data\nReload achievement_criteria_data table.'),
	('reload achievement_reward', 4, 'Syntax: .reload achievement_reward\nReload achievement_reward table.'),
	('reload all achievement', 4, 'Syntax: .reload all achievement\r\n\r\nReload achievement_reward, achievement_criteria_data tables.'),
	('reload all area', 4, 'Syntax: .reload all area\r\n\r\nReload areatrigger_teleport, areatrigger_tavern, game_graveyard_zone tables.'),
	('reload auctions', 4, 'Syntax: .reload auctions\nReload dynamic data tables from the database.'),
	('reload mail_level_reward', 4, 'Syntax: .reload mail_level_reward\nReload mail_level_reward table.'),
	('reload smart_scripts', 4, 'Syntax: .reload smart_scripts\nReload smart_scripts table.'),
	('reload vehicle_accessory', 4, 'Syntax: .reload vehicle_accessory\n\nReloads GUID-based vehicle accessory definitions from the database.'),
	('reload vehicle_template_accessory', 4, 'Syntax: .reload vehicle_template_accessory\n\nReloads entry-based vehicle accessory definitions from the database.'),
	...
	('reload waypoint_data', 4, 'Syntax: .reload waypoint_data will reload waypoint_data table.'),
	...
	('group disband', 4, 'Syntax: .group disband [$characterName]\n\nDisbands the given character\'s group.'),
	('group remove', 4, 'Syntax: .group remove [$characterName]\n\nRemoves the given character from his group.'),
	('debug moveflags', 4, 'Syntax: .debug moveflags [$newMoveFlags [$newMoveFlags2]]\r\nNo params given will output the current moveflags of the target'),
	('reload locales_creature_text', 4, 'Syntax: .reload locales_creature_text\nReload locales_creature_text Table.'),
	('morph', 4, 'Syntax: .morph #displayid\r\n\r\nChange your current model id to #displayid.'),
	('modify currency', 4, 'Syntax: .modify currency #id #value\nAdd $amount (without precision) of $currency to the selected player.'),
	('npc set data', 4, 'Syntax: .npc set data $field $data\nSets data for the selected creature. Used for testing Scripting'),
	('disable add quest', 4, 'Syntax: .disable add quest $entry $flag $comment'),
	('disable add map', 4, 'Syntax: .disable add map $entry $flag $comment'),
	('disable add battleground', 4, 'Syntax: .disable add battleground $entry $flag $comment'),
	('disable add achievement_criteria', 4, 'Syntax: .disable add achievement_criteria $entry $flag $comment'),
	('disable add spell', 4, 'Syntax: .disable add spell $entry $flag $comment'),
	('disable add outdoorpvp', 4, 'Syntax: .disable add outdoorpvp $entry $flag $comment'),
	('disable add vmap', 4, 'Syntax: .disable add vmap $entry $flag $comment'),
	('disable remove quest', 4, 'Syntax: .disable remove quest $entry'),
	('disable remove map', 4, 'Syntax: .disable remove map $entry'),
	('disable remove battleground', 4, 'Syntax: .disable remove battleground $entry'),
	('disable remove achievement_criteria', 4, 'Syntax: .disable remove achievement_criteria $entry'),
	('disable remove spell', 4, 'Syntax: .disable remove spell $entry'),
	('disable remove outdoorpvp', 4, 'Syntax: .disable remove outdoorpvp $entry'),
	('disable remove vmap', 4, 'Syntax: .disable remove vmap $entry'),
	('bf start', 4, 'Syntax: .bf start #battleid'),
	('bf stop', 4, 'Syntax: .bf stop #battleid'),
	('bf enable', 4, 'Syntax: .bf enable #battleid'),
	('bf switch', 4, 'Syntax: .bf switch #battleid'),
	('bf timer', 4, 'Syntax: .bf timer #battleid #timer'),
	...
	('cheat waterwalk', 4, 'Syntax: .cheat waterwalk on/off\r\nSet on/off waterwalk state for selected player or self if no player selected.'),
	('debug phase', 4, 'Syntax: .debug phase\r\n\r\nSends a phase debug report of a player to you.'),
	('cheat status', 4, 'Syntax: .cheat status \n\nShows the cheats you currently have enabled.'),
	('character getrename ', 4, 'Syntax: .character getrename [#guid|$oldName]\nShow the new name of the player #guid or #oldName'),
	('guild rename', 4, 'Syntax: .guild rename "$GuildName" "$NewGuildName" \n\n Rename a guild named $GuildName with $NewGuildName. Guild name and new guild name must in quotes.'),
	('anticheat global', 4, 'babab'),
	('flusharenapoints', 4, 'babab'),
	('reset spec', 4, 'Syntax: .reset spec [Playername]\r\n  Removes the player specialization \r\n. Playername can be name of offline character.'),
	('ticket fsccreate', 0, ' '),
	('ticket fscupdate', 3, ' '),
	('ticket fscdelete', 3, ' '),
	('ticket fscticketget', 0, ' '),
	('ticket fscticketres', 3, ' '),
	('reload motd', 4, 'Syntax: .reload motd\r\n\r\nReload the server motd'),
	('character deleted list', 4, ''),
