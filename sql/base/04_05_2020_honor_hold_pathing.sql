...
UPDATE `creature` SET `id`=16864 WHERE `guid`=59042;
...
DELETE FROM `creature_formations` WHERE `leaderGUID`=59121;
...
DELETE FROM `creature_formations` WHERE `leaderGUID`=59135;
INSERT INTO `creature_formations` (`leaderGUID`, `memberGUID`, `dist`, `angle`, `groupAI`) VALUES
(59135, 59135, 0, 0, 2),
(59135, 59123, 3, 90, 2);
...
-- Remove Mount for War Horse and Hama
DELETE FROM `creature_addon` WHERE `guid`=56913;
DELETE FROM `creature_addon` WHERE `guid`=56914;
DELETE FROM `creature_addon` WHERE `guid`=56915; 

-- Remove Duplicates
DELETE FROM `creature` WHERE `guid` IN (57209, 57216, 57213, 57211, 92017);