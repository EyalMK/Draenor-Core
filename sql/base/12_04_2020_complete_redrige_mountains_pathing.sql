...
UPDATE `creature` SET `position_x`=-9704.2,`position_y`=-2516.38,`position_z`=61.4835 WHERE `guid`=185281;
UPDATE `creature` SET `position_x`=-9704.2,`position_y`=-2516.38,`position_z`=61.4835 WHERE `guid`=185282;
...
(@NPC,@NPC,0,0,2,0,0),
(@NPC,185281,3,315,2,0,0),
(@NPC,185282,3,45,2,0,0);

-- Pathing for Redridge Fox Entry: 43083
SET @NPC := 185283;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`=0,`MovementType`=2,`position_x`=-9721.58,`position_y`=-2583.98,`position_z`=59.99473 WHERE `guid`=@NPC;
UPDATE `creature` SET `position_x`=-9721.58,`position_y`=-2583.98,`position_z`=59.99473 WHERE `guid`=185284;
UPDATE `creature` SET `position_x`=-9721.58,`position_y`=-2583.98,`position_z`=59.99473 WHERE `guid`=185285;
UPDATE `creature` SET `position_x`=-9721.58,`position_y`=-2583.98,`position_z`=59.99473 WHERE `guid`=185286;
DELETE FROM `creature_addon` WHERE `guid`=@NPC;
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`auras`) VALUES (@NPC,@PATH,0,0,1,0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`,`point`,`position_x`,`position_y`,`position_z`,`orientation`,`delay`,`move_type`,`action`,`action_chance`,`wpguid`) VALUES
...
INSERT INTO `creature_formations` (`leaderGUID`,`memberGUID`,`dist`,`angle`,`groupAI`,`point_1`,`point_2`) VALUES
(@NPC,@NPC,0,0,2,0,0),
(@NPC,185284,2,360,2,0,0),
(@NPC,185285,4,360,2,0,0),
(@NPC,185286,6,360,2,0,0);

-- Pathing for Redridge Fox Entry: 43083
SET @NPC := 185383;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`=0,`MovementType`=2,`position_x`=-9643.77,`position_y`=-2736.02,`position_z`=59.07977 WHERE `guid`=@NPC;
UPDATE `creature` SET `position_x`=-9643.77,`position_y`=-2736.02,`position_z`=59.07977 WHERE `guid`=185384;
UPDATE `creature` SET `position_x`=-9643.77,`position_y`=-2736.02,`position_z`=59.07977 WHERE `guid`=185385;
UPDATE `creature` SET `position_x`=-9643.77,`position_y`=-2736.02,`position_z`=59.07977 WHERE `guid`=185386;
DELETE FROM `creature_addon` WHERE `guid`=@NPC;
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`auras`) VALUES (@NPC,@PATH,0,0,1,0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`,`point`,`position_x`,`position_y`,`position_z`,`orientation`,`delay`,`move_type`,`action`,`action_chance`,`wpguid`) VALUES
...
INSERT INTO `creature_formations` (`leaderGUID`,`memberGUID`,`dist`,`angle`,`groupAI`,`point_1`,`point_2`) VALUES
(@NPC,@NPC,0,0,2,0,0),
(@NPC,185384,2,360,2,0,0),
(@NPC,185385,4,360,2,0,0),
(@NPC,185386,6,360,2,0,0);
...
UPDATE `creature` SET `position_x`=-9542.13,`position_y`=-1903.63,`position_z`=72.77375 WHERE `guid`=184717;
DELETE FROM `creature_addon` WHERE `guid`=@NPC;
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`auras`) VALUES (@NPC,@PATH,0,0,1,0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`,`point`,`position_x`,`position_y`,`position_z`,`orientation`,`delay`,`move_type`,`action`,`action_chance`,`wpguid`) VALUES
