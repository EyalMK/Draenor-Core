UPDATE `gameobject_template` SET `data4`=0, `data6`=0 WHERE `entry`=2705;
UPDATE `gameobject_template` SET `data4`=0, `data6`=0, `type`=8, `data0`=5, `data1`=20, `data3`=0, `data5`=0, `data8`=0 WHERE `entry`=138492;


UPDATE `creature_template` SET `faction`=14 WHERE `entry`=2755;
