-- New missing spawns Stormwind Gryphon Rider
DELETE FROM `creature` WHERE `guid` BETWEEN 10695750 AND 10695755;
...
(10695750, 51348, 0, 1519, 5148, 1, 1, 37310, 0, -8877.583, 683.8333, 133.6176, 5.14615, 120, 0, 0, 116235, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, NULL),
(10695751, 51348, 0, 1519, 5154, 1, 1, 37310, 0, -9017.339, 933.632, 160.745, 5.14615, 120, 0, 0, 116235, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, NULL),
(10695752, 51348, 0, 1519, 5148, 1, 1, 37310, 0, -8733.926, 621.0643, 145.5585, 5.14615, 120, 0, 0, 116235, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, NULL),
(10695753, 51348, 0, 1519, 1519, 1, 1, 37310, 0, -8557.021, 700.4496, 202.7837, 5.14615, 120, 0, 0, 116235, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, NULL),
(10695754, 51348, 0, 1519, 5150, 1, 1, 37310, 0, -8439.601, 624.75, 150.5282, 5.14615, 120, 0, 0, 116235, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, NULL);
...
SET @NPC := 189231;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`=0,`MovementType`=2,`position_x`=-8699.545,`position_y`=937.3351,`position_z`=137.8757 WHERE `guid`IN (@NPC, 189310, 10645755);
UPDATE `creature` SET `position_x`=-8699.545,`position_y`=937.3351,`position_z`=137.8757 WHERE `guid`=@NPC;
UPDATE `creature` SET `position_x`=-8699.545,`position_y`=937.3351,`position_z`=137.8757 WHERE `guid` IN (189310, 10645755);
DELETE FROM `creature_addon` WHERE `guid` IN (@NPC, 189310, 10645755);
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`auras`) VALUES
(@NPC,@PATH,27913,50331648,257,0, ''),
...
DELETE FROM `creature_formations` WHERE `leaderGUID`=189231;
INSERT INTO `creature_formations` (`leaderGUID`,`memberGUID`,`dist`,`angle`,`groupAI`) VALUES
(189231,189231,0,0,2),
(189231,189310,5,90,2),
(189231,10645755,5,270,2);

-- Pathing for Stormwind Gryphon Rider Entry: 51348 'TDB FORMAT' 
SET @NPC := 188683;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`=0,`MovementType`=2,`position_x`=-8985.317,`position_y`=666.3455,`position_z`=170.0036 WHERE `guid` IN (@NPC, @NPC+1, @NPC-1);
UPDATE `creature` SET `position_x`=-8985.317,`position_y`=666.3455,`position_z`=170.0036 WHERE `guid`=@NPC;
UPDATE `creature` SET `position_x`=-8985.317,`position_y`=666.3455,`position_z`=170.0036 WHERE `guid`IN (@NPC+1, @NPC-1);
DELETE FROM `creature_addon` WHERE `guid` IN (@NPC, @NPC+1, @NPC-1);
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`auras`) VALUES
(@NPC,@PATH,27913,50331648,257,0, ''),
(@NPC+1,0,27913,50331648,257,0, ''),
(@NPC-1,0,27913,50331648,257,0, '');
...
-- Set Formation/Group Combat Assistance
DELETE FROM `creature_formations` WHERE `leaderGUID`=188683;
DELETE FROM `creature_formations` WHERE `memberGUID` IN (188683, 188682, 188684);
INSERT INTO `creature_formations` (`leaderGUID`,`memberGUID`,`dist`,`angle`,`groupAI`) VALUES
(188683,188683,0,0,2),
(188683,188684,5,90,2),
(188683,188682,5,270,2);
