...
-- 13. Stormshield Officer
SET @NPC := 10181865;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`=0,`MovementType`=2,`position_x`=3610.942,`position_y`=-3935.089,`position_z`=16.77913 WHERE `guid`=@NPC;
DELETE FROM `creature_addon` WHERE `guid`=@NPC;
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`auras`) VALUES (@NPC,@PATH,28917,0,1,0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`,`point`,`position_x`,`position_y`,`position_z`,`orientation`,`delay`,`move_type`,`action`,`action_chance`,`wpguid`) VALUES
(@PATH,1,3610.942,-3935.089,16.77913,0,0,0,0,100,0),
(@PATH,2,3622.692,-3940.839,17.27913,0,0,0,0,100,0),
(@PATH,3,3634.192,-3937.089,18.02913,0,0,0,0,100,0),
(@PATH,4,3640.942,-3930.339,17.77913,0,0,0,0,100,0),
(@PATH,5,3651.442,-3922.839,17.77913,0,0,0,0,100,0),
(@PATH,6,3657.442,-3928.839,18.77913,0,0,0,0,100,0),
(@PATH,7,3668.692,-3942.839,23.02913,0,0,0,0,100,0),
(@PATH,8,3677.692,-3949.339,25.77913,0,0,0,0,100,0),
(@PATH,9,3689.942,-3950.339,27.27913,0,0,0,0,100,0),
(@PATH,16,3622.692,-3940.839,17.27913,0,0,0,0,100,0),
(@PATH,15,3634.192,-3937.089,18.02913,0,0,0,0,100,0),
(@PATH,14,3640.942,-3930.339,17.77913,0,0,0,0,100,0),
(@PATH,13,3651.442,-3922.839,17.77913,0,0,0,0,100,0),
(@PATH,12,3657.442,-3928.839,18.77913,0,0,0,0,100,0),
(@PATH,11,3668.692,-3942.839,23.02913,0,0,0,0,100,0),
(@PATH,10,3677.692,-3949.339,25.77913,0,0,0,0,100,0);
