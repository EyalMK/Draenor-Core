...
DELETE FROM `gossip_menu` WHERE (`entry`=12568 AND `text_id`=17676);
INSERT INTO `gossip_menu` (`entry`, `text_id`) VALUES
(12568, 17676); -- 50270 (Captain Taylor)

DELETE FROM `gossip_menu_option` WHERE (`menu_id`=11469 AND `option_id`=0);
INSERT INTO `gossip_menu_option` (`menu_id`, `option_id`, `option_icon`, `option_text`, `OptionBroadcastTextId`) VALUES
(11469, 0, 0, 'We are ready!', 41133);

DELETE FROM `creature_text` WHERE `entry` IN (39959,40586,40765,40788,40792,40825);
