...
#define DEFINE_OPCODE_HANDLER_OLD(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_DF_BOOT_PLAYER_VOTE,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::LFG::DFBootPlayerVote, &WorldSession::HandleLfgSetBootVoteOpcode);
    DEFINE_HANDLER(CMSG_DF_GET_JOIN_STATUS,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   WorldPackets::LFG::DFGetJoinStatus, &WorldSession::HandleDFGetJoinStatus);
    ...
    DEFINE_HANDLER(CMSG_DF_JOIN,                                            STATUS_LOGGEDIN,  PROCESS_INPLACE,      WorldPackets::LFG::DFJoin, &WorldSession::HandleLfgJoinOpcode             );
    DEFINE_HANDLER(CMSG_DF_LEAVE,                                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      WorldPackets::LFG::DFLeave, &WorldSession::HandleLfgLeaveOpcode            );
    DEFINE_HANDLER(CMSG_DF_PROPOSAL_RESPONSE,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::LFG::DFProposalResponse, &WorldSession::HandleLfgProposalResultOpcode   );
    ...
    DEFINE_HANDLER(CMSG_DF_SET_ROLES,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::LFG::DFSetRoles, &WorldSession::HandleLfgSetRolesOpcode         );
    DEFINE_HANDLER(CMSG_DF_TELEPORT,                                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::LFG::DFTeleport, &WorldSession::HandleLfgTeleportOpcode         );
