...
public:
	...
	struct instance_scarlet_monastery_InstanceMapScript : public InstanceScript
	{
		...
		void OnCreatureCreate(Creature* creature)
		{
			...
			case NPC_THALNOS: thalnosGUID = creature->GetGUID(); break;
			case NPC_KORLOFF: korloffGUID = creature->GetGUID(); break;
			case NPC_DURAND: durandGUID = creature->GetGUID(); break;
			case NPC_WHITEMANE: whitemaneGUID = creature->GetGUID(); break;
			}
		}
