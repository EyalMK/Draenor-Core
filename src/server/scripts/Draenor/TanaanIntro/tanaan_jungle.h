...
namespace TanaanSceneObjects
{
    enum
    {
		...
		// Area Dark Portal
        SceneSoulTrain                       = 1018,
		SceneLightingSpireNorth				 = 959,
		SceneLightingSpireSouth				 = 960,
		SceneFelShifted						 = 932, // no idea
		SceneLoomingArmy					 = 923,
		SceneDwarfs						     = 937, // Used for the Onslaught quest, needs a trigger scene to explode
		SceneKhadgarBombs					 = 924,
		...
		SceneBloodBowl						 = 1029,
		SceneSneakyArmy						 = 942, // Khadgar and the others are running through
...
namespace TanaanCreatures
{
    ...
    {
        NpcIronGrunt                         = 78883,
		NpcIronmarchGrunt					 = 76556,
		NpcShadowRitualist					 = 81711,
...
namespace TanaanGameObjects
{
    enum
    {
		...
		GobNorthSpire						 = 236690,
		GobSouthSpire						 = 236691,
		GobCenterSpire						 = 236692 // Not a spire, it's the souls coming out from gul'dan
    };
}
